...
public class SingleOuttakeControl {
    ...
    private static final int LIFT_TOLERANCE_L = 0, LIFT_TOLERANCE_R = 10;
    private static final int LOWER_TOLERANCE_L = 0, LOWER_TOLERANCE_R = 10;
    ...
    public void init(HardwareMap hwMap, String deviceName, boolean isReversed) {
        outtakeMotor1 = hwMap.get(DcMotor.class, deviceName);
...
//        kI = 0;
    ...
    public void updatePID() {
        ...
        if (Math.abs(error) <= 18) { // Lower max power when closing in on
            maxPower = 0.15;
        }
