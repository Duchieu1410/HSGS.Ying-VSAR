...
public class MecanumDrive {
    ...
    public void init(HardwareMap hwMap) {
        frontLeftMotor = hwMap.get(DcMotor.class, "fl_motor"/*"front_left_motor"*/);
        frontRightMotor = hwMap.get(DcMotor.class, "fr_motor"/*"front_right_motor"*/);
        backLeftMotor = hwMap.get(DcMotor.class, "bl_motor"/*"back_left_motor"*/);
        backRightMotor = hwMap.get(DcMotor.class, "br_motor"/*"back_right_motor"*/);
